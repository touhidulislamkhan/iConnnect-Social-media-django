...
def sign_up(request):
    ...
    return render(request, 'App_Login/signup.html', context={'title': "Sign Up . iConnect", 'form': form})
...
def edit_profile(request):
    ...
    return render(request, 'App_Login/profile.html', context={'title': "Edit Profile . iConnect", 'form': form})
